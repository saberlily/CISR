/**
 * @author		Tien Nguyen
 * @version		$Id: NSN.js, v1.0 2012/07/03 tiennguyen Exp $
 */
...
(function(window, jQuery) {
    if (jQuery) {
        ...
        nsn.browser = {};
        nsn.browser = {};
        nsn.browser.mozilla = /mozilla/.test(navigator.userAgent.toLowerCase()) && !/webkit/.test(navigator.userAgent.toLowerCase());
        nsn.browser.webkit = /webkit/.test(navigator.userAgent.toLowerCase());
        nsn.browser.opera = /opera/.test(navigator.userAgent.toLowerCase());
        nsn.browser.msie = /msie/.test(navigator.userAgent.toLowerCase());
        ...
        nsn.isIE = function(ver) {
            var yes = 'undefined' != typeof nsn.browser.msie;
            if (ver) {
                if (nsn.isNumber(ver))
                    return yes && parseInt(nsn.browser.version, 10) == (ver < 1 ? 6 : ver);
            } else
                return yes;
        };
        nsn.isIE6 = function() {
...
(function(nsn, jQuery) {
    ...
    NSN_alertError = function(msg) {
        nsn.createJqDlg(glbDefaultDlgId,
            '<div class="dialog_popup_msg ui-state-error">' + msg + '</div>')
            .dialog('open');
    };
